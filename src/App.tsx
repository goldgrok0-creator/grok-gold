...
import { TransactionsPage } from './pages/Others';
    ...
    <div className="w-full min-h-screen bg-[#040108] text-slate-100 flex flex-col items-center font-sans antialiased">
      ...
      {(currentPath.startsWith('/admin') || currentTab === 'admin') ? (
        ...
        {!state.isLoggedIn ? (
          ...
          <>
            ...
            <div className={`flex-1 px-4 py-3 overflow-x-hidden ${
              ...
              {/* HOME VIEW */}
              {currentTab === 'home' && <HomePage setHarvestModalOpen={setHarvestModalOpen} />}
              ...
              {/* DEPOSIT SALDO VIEW */}
              {currentTab === 'deposit' && <DepositPage />}
        ...
        <WithdrawModal
          ...
          setWithdrawAccount={setWithdrawAccount}
          withdrawAmount={withdrawAmount}
          setWithdrawAmount={setWithdrawAmount}
          rewardBalance={state.rewardBalance ?? 0}
